...
function library:CreateWindow(options, ...)
	...
	if windowName and #windowName > 0 and library.WorkspaceName == "OhioBin" then
		library.WorkspaceName = convertfilename(windowName, "OhioBin")
	end
